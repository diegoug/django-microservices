...
THIS_SERVICE = os.environ.get('backend_for_frontend_ms_HOST', '')
...
MIDDLEWARE = [
    ...
    'backend_for_frontend_ms.middleware.TimezoneMiddleware', # app
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'backend_for_frontend_ms.middleware.SetOautClientCredentials' # app
]

ROOT_URLCONF = 'backend_for_frontend_ms.urls'
...
STATIC_URL = '/backend_for_frontend_ms/static/'
...
MEDIA_URL = '/backend_for_frontend_ms/media/'

WSGI_APPLICATION = 'backend_for_frontend_ms.wsgi.application'
